...
| 5 | probe 2026-09-03 — groom-worktree test | Probe row proving grooming runs while the shared checkout is on a feature branch | none — probe row, class 'other' so it lands in ASK and can never build unattended | ASK | OPEN |  |
