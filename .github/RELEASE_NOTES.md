...
- **Smart Improvement**: Brought back with usage-based behavior; thresholds and cooldown to avoid noisy updates; diff-style presentation, short rationale, and explicit **NO_CHANGE** when no edit is needed.
