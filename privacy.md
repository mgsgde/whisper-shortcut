...
- **When it’s collected**: Interaction logging is **off by default**. Enable **"Save usage data"** in Settings > Smart Improvement to store interaction logs. Data stays on your device until you delete it or it is automatically removed (see retention).
